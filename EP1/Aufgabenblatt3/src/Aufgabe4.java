...
public class Aufgabe4 {
    ...
    private static int countNOrderedPairs(String text, int index) {
        ...
        return (first <= second ? 1 : 0) + countNOrderedPairs(text, index + 1);
    }
    ...
    private static String shiftAllSignsRight(String text, char sign) {
        ...
        if (firstChar == sign)
            return shiftAllSignsRight(newText, sign) + firstChar;
        else
            return firstChar + shiftAllSignsRight(newText, sign);
    }
